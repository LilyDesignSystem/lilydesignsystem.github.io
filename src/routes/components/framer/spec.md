# framer — Specification

Single source of truth for spec-driven development of the framer component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the framer component: framer.
...
1. Render `<div>` as the root element with `class="framer"`
