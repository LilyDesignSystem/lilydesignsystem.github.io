# CollectionListItem — Specification

Single source of truth for spec-driven development of the CollectionListItem component. Consolidates the prior `plan.md` and `tasks.md`.
...
- [ ] Add CSS class .collection-list-item to css-style-sheet-template.css
