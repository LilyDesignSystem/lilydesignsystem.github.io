...
Single source of truth for spec-driven development of the CodeBlock component. Consolidates the prior `plan.md` and `tasks.md`.
...
- [x] Add CSS class .code-block to css-style-sheet-template.css

### In Progress

- [ ] Implement HTML headless component (code-block.html)
- [ ] Implement HTML headless test (code-block.test.js)
