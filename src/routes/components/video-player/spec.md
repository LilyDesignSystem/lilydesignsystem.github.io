...
Single source of truth for spec-driven development of the video-player component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the video-player component: video-player.
...
1. Render `<div>` as the root element with `class="video-player"`
...
- [ ] Renders `<div>` with class `video-player`
