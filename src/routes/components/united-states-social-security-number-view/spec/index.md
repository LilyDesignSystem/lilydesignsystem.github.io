# United States Social Security Number View — Specification

Single source of truth for spec-driven development of the United States Social Security Number View component. Consolidates the prior `plan.md` and `tasks.md`.
