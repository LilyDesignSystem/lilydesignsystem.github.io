# scroller — Specification

Single source of truth for spec-driven development of the scroller component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the scroller component: scroller.
...
1. Render `<div>` as the root element with `class="scroller"`
...
- [ ] Renders `<div>` with class `scroller`
