# Contents List — Specification

Single source of truth for spec-driven development of the Contents List component. Consolidates the prior `plan.md` and `tasks.md`.
