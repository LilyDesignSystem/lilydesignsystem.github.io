# OverlayContainer — Specification

Single source of truth for spec-driven development of the OverlayContainer component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the OverlayContainer component: a full-viewport overlay backdrop for modals and sheets.
...
1. Use semantic <div> element with class="overlay-container"
...
- [ ] Renders <div> with class="overlay-container"
...
- [ ] Add CSS class .overlay-container to css-style-sheet-template.css
