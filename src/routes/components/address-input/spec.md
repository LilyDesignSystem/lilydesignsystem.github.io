# AddressInput — Specification

Single source of truth for spec-driven development of the AddressInput component. Consolidates the prior `plan.md` and `tasks.md`.
