# Accordion Link — Specification

Single source of truth for spec-driven development of the Accordion Link component. Consolidates the prior `plan.md` and `tasks.md`.
