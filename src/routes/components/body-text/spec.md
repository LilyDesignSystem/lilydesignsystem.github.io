...
Single source of truth for spec-driven development of the body-text component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the body-text component: body-text.
...
1. Render `<div>` as the root element with `class="body-text"`
...
- [ ] Renders `<div>` with class `body-text`
