...
<svelte:head>
  <title>Bulgaria Edinen Grazhdanski Nomer View — Lily Design System</title>
  <meta name="description" content="a read-only display of Bulgaria's Единен граждански номер / Edinen grazhdanski nomer (EGN)" />
</svelte:head>
...
<section class="component-contract prose" aria-labelledby="contract-heading" style="max-width: 64rem; margin: 0 auto; padding: 0 1rem 2rem;">
  ...
  <p>
    ...
    <a href="https://github.com/LilyDesignSystem/lily-design-system/blob/main/components/bulgaria-edinen-grazhdanski-nomer-view/AGENTS.md">canonical metadata</a>
    — the machine-checked source the implementations are held to.
  </p>
    <h3>Metadata</h3>
    <ul>
      <li>Component: bulgaria-edinen-grazhdanski-nomer-view</li>
      <li>PascalCase: BulgariaEdinenGrazhdanskiNomerView</li>
      <li>Description: a read-only display of Bulgaria's Единен граждански номер / Edinen grazhdanski nomer (EGN)</li>
      <li>Status: beta — implemented and unit-tested in all seven frameworks with an axe-clean demo page; not yet exercised in composed flows</li>
      <li>HTML tag: &lt;span&gt;</li>
      <li>CSS class: .bulgaria-edinen-grazhdanski-nomer-view</li>
