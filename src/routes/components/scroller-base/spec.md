# scroller-base — Specification

Single source of truth for spec-driven development of the scroller-base component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the scroller-base component: scroller-base.
...
1. Render `<div>` as the root element with `class="scroller-base"`
...
- [ ] Renders `<div>` with class `scroller-base`
