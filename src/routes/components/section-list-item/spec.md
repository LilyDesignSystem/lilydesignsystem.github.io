# SectionListItem — Specification

Single source of truth for spec-driven development of the SectionListItem component. Consolidates the prior `plan.md` and `tasks.md`.
