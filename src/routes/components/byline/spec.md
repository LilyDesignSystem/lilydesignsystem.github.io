...
Single source of truth for spec-driven development of the byline component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the byline component: byline.
...
1. Render `<div>` as the root element with `class="byline"`
