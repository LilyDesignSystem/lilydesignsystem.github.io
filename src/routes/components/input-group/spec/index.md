...
Single source of truth for spec-driven development of the InputGroup component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the InputGroup component: a group wrapping an input with prefix and suffix addons.
...
1. Use semantic <div> element with class="input-group"
...
- [ ] Renders <div> with class="input-group"
...
- [ ] Add CSS class .input-group to css-style-sheet-template.css
