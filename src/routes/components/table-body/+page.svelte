...
<svelte:head>
  <title>Table Body — Lily Design System</title>
  <meta name="description" content="TableBody is a headless component that renders a &lt;tbody&gt; element within a table. It groups the main data rows of the table." />
</svelte:head>
