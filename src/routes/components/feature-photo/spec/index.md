# feature-photo — Specification

Single source of truth for spec-driven development of the feature-photo component. Consolidates the prior `plan.md` and `tasks.md`.
