# Coachmark — Specification

Single source of truth for spec-driven development of the Coachmark component. Consolidates the prior `plan.md` and `tasks.md`.
...
- [ ] Add CSS class .coachmark to css-style-sheet-template.css
- [ ] Add tests for stable id generation
- [ ] Add accessibility tests for aria-labelledby / aria-describedby wiring
