# Information Callout — Specification

Single source of truth for spec-driven development of the Information Callout component. Consolidates the prior `plan.md` and `tasks.md`.
