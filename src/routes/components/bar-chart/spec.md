...
Single source of truth for spec-driven development of the BarChart component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the BarChart component: a horizontal bar chart visualization for displaying data.
...
1. Render `<figure>` as the root element with `class="bar-chart"`
...
- [ ] Renders `<figure>` with class `bar-chart`
