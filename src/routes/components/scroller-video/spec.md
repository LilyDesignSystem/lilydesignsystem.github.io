# scroller-video — Specification

Single source of truth for spec-driven development of the scroller-video component. Consolidates the prior `plan.md` and `tasks.md`.
