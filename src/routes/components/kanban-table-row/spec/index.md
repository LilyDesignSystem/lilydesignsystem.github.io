# Kanban Table Row — Specification

Single source of truth for spec-driven development of the Kanban Table Row component. Consolidates the prior `plan.md` and `tasks.md`.
