# InfoState — Specification

Single source of truth for spec-driven development of the InfoState component. Consolidates the prior `plan.md` and `tasks.md`.
...
- [ ] Add CSS class .info-state to css-style-sheet-template.css
