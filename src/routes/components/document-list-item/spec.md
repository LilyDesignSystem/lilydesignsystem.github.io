# DocumentListItem — Specification

Single source of truth for spec-driven development of the DocumentListItem component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the DocumentListItem component: one document entry in a document list.
...
1. Render `<li>` as the root element with `class="document-list-item"`
...
- [ ] Renders `<li>` with class `document-list-item`
