...
<svelte:head>
  <title>Suomi Henkilotunnus Input — Lily Design System</title>
  <meta name="description" content="an input for entering Finland's Henkilötunnus (HETU)" />
</svelte:head>
...
<section class="component-contract prose" aria-labelledby="contract-heading" style="max-width: 64rem; margin: 0 auto; padding: 0 1rem 2rem;">
  ...
  <p>
    ...
    <a href="https://github.com/LilyDesignSystem/lily-design-system/blob/main/components/suomi-henkilotunnus-input/AGENTS.md">canonical metadata</a>
    — the machine-checked source the implementations are held to.
  </p>
    <h3>Metadata</h3>
    <ul>
      <li>Component: suomi-henkilotunnus-input</li>
      <li>PascalCase: SuomiHenkilotunnusInput</li>
      <li>Description: an input for entering Finland's Henkilötunnus (HETU)</li>
      <li>Status: beta — implemented and unit-tested in all seven frameworks with an axe-clean demo page; not yet exercised in composed flows</li>
      <li>HTML tag: &lt;input&gt;</li>
      <li>CSS class: .suomi-henkilotunnus-input</li>
