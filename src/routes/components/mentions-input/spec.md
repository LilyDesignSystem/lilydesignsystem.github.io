# MentionsInput — Specification

Single source of truth for spec-driven development of the MentionsInput component. Consolidates the prior `plan.md` and `tasks.md`.
...
- [ ] Add CSS class .mentions-input to css-style-sheet-template.css
