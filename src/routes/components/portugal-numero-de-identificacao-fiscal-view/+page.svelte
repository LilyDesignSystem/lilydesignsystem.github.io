...
<svelte:head>
  <title>Portugal Numero De Identificacao Fiscal View — Lily Design System</title>
  <meta name="description" content="a read-only display of Portugal's Número de Identificação Fiscal (NIF)" />
</svelte:head>
...
<section class="component-contract prose" aria-labelledby="contract-heading" style="max-width: 64rem; margin: 0 auto; padding: 0 1rem 2rem;">
  ...
  <p>
    ...
    <a href="https://github.com/LilyDesignSystem/lily-design-system/blob/main/components/portugal-numero-de-identificacao-fiscal-view/AGENTS.md">canonical metadata</a>
    — the machine-checked source the implementations are held to.
  </p>
    <h3>Metadata</h3>
    <ul>
      <li>Component: portugal-numero-de-identificacao-fiscal-view</li>
      <li>PascalCase: PortugalNumeroDeIdentificacaoFiscalView</li>
      <li>Description: a read-only display of Portugal's Número de Identificação Fiscal (NIF)</li>
      <li>Status: beta — implemented and unit-tested in all seven frameworks with an axe-clean demo page; not yet exercised in composed flows</li>
      <li>HTML tag: &lt;span&gt;</li>
      <li>CSS class: .portugal-numero-de-identificacao-fiscal-view</li>
