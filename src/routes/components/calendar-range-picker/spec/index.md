# Calendar Range Picker — Specification

Single source of truth for spec-driven development of the Calendar Range Picker component. Consolidates the prior `plan.md` and `tasks.md`.
