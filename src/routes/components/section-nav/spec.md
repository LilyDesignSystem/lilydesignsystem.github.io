# SectionNav — Specification

Single source of truth for spec-driven development of the SectionNav component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the SectionNav component: a navigation container for section navigation links.
...
1. Render `<nav>` as the root element with `class="section-nav"`
...
- [ ] Renders `<nav>` with class `section-nav`
