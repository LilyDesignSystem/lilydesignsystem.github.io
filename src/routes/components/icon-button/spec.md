...
Single source of truth for spec-driven development of the IconButton component. Consolidates the prior `plan.md` and `tasks.md`.
...
- [ ] Add CSS class .icon-button to css-style-sheet-template.css
