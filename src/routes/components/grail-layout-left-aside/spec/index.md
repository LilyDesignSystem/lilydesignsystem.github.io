# Grail Layout Left Aside — Specification

Single source of truth for spec-driven development of the Grail Layout Left Aside component. Consolidates the prior `plan.md` and `tasks.md`.
