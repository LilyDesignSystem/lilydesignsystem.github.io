<script lang="ts">
  const html: string = "<h1>Lietuva Asmens Kodas Input</h1>\n\n<p>an input for entering Lithuania's Asmens kodas</p>\n\n<p>This is a new component. See <a href=\"https://github.com/joelparkerhenderson/lily-design-system/tree/main/components/lietuva-asmens-kodas-input\">the canonical documentation</a> for full details.</p>";
...
<svelte:head>
  <title>Lietuva Asmens Kodas Input — Lily Design System</title>
  <meta name="description" content="an input for entering Lithuania's Asmens kodas" />
</svelte:head>
...
<section class="component-contract prose" aria-labelledby="contract-heading" style="max-width: 64rem; margin: 0 auto; padding: 0 1rem 2rem;">
  ...
  <p>
    ...
    <a href="https://github.com/LilyDesignSystem/lily-design-system/blob/main/components/lietuva-asmens-kodas-input/AGENTS.md">canonical metadata</a>
    — the machine-checked source the implementations are held to.
  </p>
    <h3>Metadata</h3>
    <ul>
      <li>Component: lietuva-asmens-kodas-input</li>
      <li>PascalCase: LietuvaAsmensKodasInput</li>
      <li>Description: an input for entering Lithuania's Asmens kodas</li>
      <li>Status: beta — implemented and unit-tested in all seven frameworks with an axe-clean demo page; not yet exercised in composed flows</li>
      <li>HTML tag: &lt;input&gt;</li>
      <li>CSS class: .lietuva-asmens-kodas-input</li>
