# ContainerWithFixedWidth — Specification

Single source of truth for spec-driven development of the ContainerWithFixedWidth component. Consolidates the prior `plan.md` and `tasks.md`.
...
- [ ] Add CSS class .container-with-fixed-width to css-style-sheet-template.css
