# graphic-block — Specification

Single source of truth for spec-driven development of the graphic-block component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the graphic-block component: graphic-block.
...
1. Render `<figure>` as the root element with `class="graphic-block"`
...
- [ ] Renders `<figure>` with class `graphic-block`
