# TimeoutDialog — Specification

Single source of truth for spec-driven development of the TimeoutDialog component. Consolidates the prior `plan.md` and `tasks.md`.
