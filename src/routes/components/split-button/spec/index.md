...
Single source of truth for spec-driven development of the SplitButton component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the SplitButton component: a button with a primary action and a dropdown for related actions.
...
1. Use semantic <div> element with class="split-button"
...
- [ ] Renders <div> with class="split-button"
...
- [ ] Add CSS class .split-button to css-style-sheet-template.css
