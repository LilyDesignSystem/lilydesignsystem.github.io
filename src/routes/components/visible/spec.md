...
Single source of truth for spec-driven development of the visible component. Consolidates the prior `plan.md` and `tasks.md`.

## Goal

Implement the visible component: visible.
...
1. Render `<div>` as the root element with `class="visible"`
...
- [ ] Renders `<div>` with class `visible`
