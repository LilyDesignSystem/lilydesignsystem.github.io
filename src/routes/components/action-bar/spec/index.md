# ActionBar — Specification

Single source of truth for spec-driven development of the ActionBar component. Consolidates the prior `plan.md` and `tasks.md`.
...
- [ ] Add CSS class .action-bar to css-style-sheet-template.css
- [ ] Add comprehensive accessibility tests
- [ ] Add integration tests with action-bar-button children
