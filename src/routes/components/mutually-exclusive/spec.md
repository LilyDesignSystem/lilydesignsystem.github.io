# MutuallyExclusive — Specification

Single source of truth for spec-driven development of the MutuallyExclusive component. Consolidates the prior `plan.md` and `tasks.md`.
