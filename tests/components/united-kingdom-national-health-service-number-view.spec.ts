...
const title = 'United Kingdom National Health Service Number View';
...
test.describe('component page: ' + slug, () => {
  ...
  test('document title contains the component name', async ({ page }) => {
    await expect(page).toHaveTitle(/United Kingdom National Health Service Number View\s+\u2014\s+Lily Design System/);
  });
