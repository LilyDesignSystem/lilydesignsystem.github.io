...
const title = 'France Numero D Identification Au Repertoire View';
...
test.describe('component page: ' + slug, () => {
  ...
  test('document title contains the component name', async ({ page }) => {
    await expect(page).toHaveTitle(/France Numero D Identification Au Repertoire View\s+\u2014\s+Lily Design System/);
  });
