...
const title = 'France Numero D Identification Au Repertoire Input';
...
test.describe('component page: ' + slug, () => {
  ...
  test('document title contains the component name', async ({ page }) => {
    await expect(page).toHaveTitle(/France Numero D Identification Au Repertoire Input\s+\u2014\s+Lily Design System/);
  });
