...
This repository is the Lily Design System documentation website.
...
```sh
git clone https://github.com/LilyDesignSystem/lilydesignsystem.github.io.git
cd lilydesignsystem.github.io
npm install
npm run dev
```
